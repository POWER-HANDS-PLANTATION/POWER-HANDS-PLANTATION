...
let cc = Config.sessionName.replace(POWER-HANDS-PLANTATION;;;/g, "").replace(POWER-HANDS-PLANTATION;;;/gi, ""); // DONT REMOVE BLACK;;; so you can connect BLACK md session id too
